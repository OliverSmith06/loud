    ...
    return (
        <div>
          ...
          <div className='accordion'>
              ...
              <div className={`accordion__header ${title == "James' Jungle" ? 'accordion__header--jungle-james' : ''} ${isExpanded ? '' : 'accordion__header--collapsed'}`}  onClick={handleClick} style={{ cursor: 'pointer' }}>
