...
function GradientPic() {
  ...
  const endDate = new Date('2024-06-07T08:40:00');   // Replace with your end date
  ...
  const calculatePercentage = () => {
    ...
    const currentPercentage: number = roundHQuarter((elapsedTime / totalTime) * 100);
  ...
  useEffect(() => {
    ...
    return (
      <div className={styles.wrapper}>
        ...
        <div style={{width: `${percentage}%`}} className={styles.seoulImg} ></div>
      </div>
    );
  }
